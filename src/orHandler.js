...
export const OrHandler = {
    canHandle(handlerInput) {
        return handlerInput.requestEnvelope.request.type === 'IntentRequest' && handlerInput.requestEnvelope.request.intent.name === 'orIntent';
    },
    handle(handlerInput) {
        ...
        const ans = BitwiseCalculator.or(number1, number2);
